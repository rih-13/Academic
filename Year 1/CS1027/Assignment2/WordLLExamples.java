...
public class WordLLExamples {
	...
	public static void main(String[] args) {
		...
		//playCards();
		System.out.println("\nGame finished.");
		System.out.println("The password was - Pass" + WordLLExamples.mysteryW + "\n\n");
	}
	...
	public static void playEnglish() {
		...
		WordLLExamples.mysteryW = mystery;
		String message = "\nEnter a word of length " + randomWord.length() + " (XX to stop):";

		WordLL wll = new WordLL(mystery);

		System.out.println("\n\nWelcome to Spy. To guess the password to the secret files, enter your guess below. !! indicates a correct letter in the correct position, "
				+ "++ indicates a correct letter in the wrong position, and -- indicates the letter is not in the word. Start off with your first guess.\n");
